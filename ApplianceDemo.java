...
public class ApplianceDemo
{
	...
	public static class ApplianceTest extends JFrame {
		...
		public static void openFile()
		{
			...
			{
				System.out.println("Error..Opening file ..openFile");
				System.exit(-1);
			}
		}
	...
	public static void addRecords(Appliance appliance)
	{
		...
		{
			System.err.println("Error writing to file. Terminating...addRecords");
	...
	public static void closeFile()
	{
		...
		{
			System.err.println("Error writing to file. Terminating.closing error");
	...
	public static void main(String[] args) {
		ApplianceTest frame = new ApplianceTest();
		frame.pack();
		frame.setTitle("Electricity Bill Mate");
		frame.setLocationRelativeTo(null); // Center the frame
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
